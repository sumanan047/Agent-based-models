...
"" ""
PENS
"" 1.0 1 -16777216 true "" "histogram loc-list"
...
The model simulates the random walk of an agent in the world in one dimension. It reports the distance walked and location of the agent with each step. 
The model also has two additional monitors which reports the mean and standard deviation of the location of the agent.
